...
const conductores = "http://localhost:5173/conductor/";
const clientes = "http://localhost:5173/";
const administracion = "http://localhost:5173/administracion/";
const mantenimiento = "http://localhost:5173/mantenimiento/";
const supervision = "http://localhost:5173/supervision/";
const gerencia = "http://localhost:5173/gerencia/";
