...
const conductores = `http://amazona-logist.netlify.app/conductor/`;
const clientes = `https://amazona-logist.netlify.app/`;
const administracion = `https://amazona-logist.netlify.app/administracion/`;
const mantenimiento = `https://amazona-logist.netlify.app/mantenimiento/`;
const supervision = `https://amazona-logist.netlify.app/supervision/`;
const gerencia = `https://amazona-logist.netlify.app/gerencia/`;
