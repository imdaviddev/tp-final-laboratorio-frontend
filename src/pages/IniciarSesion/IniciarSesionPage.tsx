...
const IniciarSesionPage = () => {
  return <>
    ...
    <ContainerPadre>
      <FormContainer>
        <DescHijo>Ingresa tus datos para iniciar sesion</DescHijo>
        <LabelForm>Nombre de Usuario</LabelForm>
        <InputForm type="text" id='username' key={'username'} placeholder='LV44509626'></InputForm>
        <LabelForm>Contraseña</LabelForm>
        <InputForm type="password" id='contrasenia' key={'contrasenia'} placeholder='Value'></InputForm>
